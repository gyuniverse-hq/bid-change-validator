...
tests = ['test_copilot_check_scope.py', 'test_local_copilot_evaluation.py', 'test_hwp_control_text.py', 'test_document_extraction.py', 'test_copilot_document_ledger.py', 'test_source_condition_contracts.py', 'test_copilot_narration.py', 'test_copilot_required_checks_narration.py',
